...
Page.add({
	...
	secondLevelPages: { type: Types.Relationship, ref: 'PageSecondLevel', many: true },
...
Page.defaultColumns = 'title, secondLevelPages|40%, state|10%, author|10%, publishedDate|20%';
